...
# import statsmodels.stats.descriptivestats as sd
data=pd.read_excel(r"C:\Users\Administrator.Gokulbhasi\Desktop\DataScience\hyphotestng\pythoncodes\Marks-1sample sign test.xlsx")
data
#############Normality test###############
...
data=pd.read_excel(r"C:\Users\Administrator.Gokulbhasi\Desktop\DataScience\hyphotestng\pythoncodes\Mann_whitney.xlsx")
data
...
promotion=pd.read_excel(r"C:\Users\Administrator.Gokulbhasi\Desktop\DataScience\hyphotestng\pythoncodes\Promotion.xlsx")
promotion
...
cof=pd.read_excel((r"C:\Users\Administrator.Gokulbhasi\Desktop\DataScience\hyphotestng\pythoncodes\ContractRenewal_Data(unstacked).xlsx")
cof
...
Bahaman=pd.read_excel(r"C:\Users\Administrator.Gokulbhasi\Desktop\DataScience\hyphotestng\pythoncodes\Bahaman.csv")
Bahaman
